...
## Новая фича: редактирование карточки ученика
- Добавлена возможность редактирования полей Школа, Учениk, Класс, Город прямо в карточке ученика.
- Изменения сохраняются в локальном JSON-файле student_data.json при каждом обновлении.
